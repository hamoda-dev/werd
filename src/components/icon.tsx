...
const GLYPHS: Record<string, ReactNode> = {
  ...
  "gearshape.fill": (
    <>
      ...
      <Path d="M12 3.4 V5.6 M12 18.4 V20.6 M3.4 12 H5.6 M18.4 12 H20.6 M5.8 5.8 L7.4 7.4 M16.6 16.6 L18.2 18.2 M18.2 5.8 L16.6 7.4 M7.4 16.6 L5.8 18.2" />
    </>
  ),
  ...
  "checkmark.seal.fill": (
    <>
      ...
      <Path d="M8.4 12.2 L11 14.8 L15.7 9.4" />
    </>
  ),
